...
vector<IniFile::Record> IniFile::GetSection(const string& SectionName)
{
    vector<Record> data;                                                    // Holds the return data
    vector<Record>& content = m_content;                                    // Holds the current record
...
vector<IniFile::Record> IniFile::GetRecord(const string& KeyName, const string& SectionName)
{
    vector<Record> data;                                                    // Holds the return data
    vector<Record>& content = m_content;                                    // Holds the current record
...
string IniFile::GetValue(const string& KeyName, const string& SectionName, const string& DefValue/* = ""*/)
{
