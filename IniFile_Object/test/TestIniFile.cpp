...
int main(int argc, char* argv[])
{
	...
	if (IniFile.SetSectionComments("# This Section was created by IniFile", "MySection")) cout << "Comments were successfully added" << endl << endl;
	...
	if (IniFile.SetRecordComments("# This Key was created by IniFile", "MyKey", "MySection")) cout << "Comments were successfully added" << endl << endl;
	else cout << "Failed to add the comments" << endl << endl;
	Show(IniFile);
	...
	if (IniFile.CommentRecord(IniFile::Pound, "MyKey", "YourSection")) cout << "Record was successfully commented" << endl << endl;
