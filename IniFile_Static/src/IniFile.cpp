...
bool IniFile::Load(string const& FileName, vector<Record>& content)
{
...
bool IniFile::Save(string const& FileName, vector<Record>& content)
{
    assert(!FileName.empty());
...
bool IniFile::FileExist(string const& FileName)
{
    assert(!FileName.empty());
...
bool IniFile::Create(string const& FileName)
{
...
vector<string> IniFile::GetSectionNames(string const& FileName)
{
...
vector<IniFile::Record> IniFile::GetSections(string const& FileName)
{
...
vector<IniFile::Record> IniFile::GetSection(string const& SectionName, string const& FileName)
{
    vector<Record> data;                                                    // Holds the return data
    vector<Record> content;                                                 // Holds the current record
...
vector<IniFile::Record> IniFile::GetRecord(string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> data;                                                    // Holds the return data
    vector<Record> content;                                                 // Holds the current record
...
string IniFile::GetValue(string const& KeyName, string const& SectionName, string const& FileName, string const& DefValue/* = ""*/)
{
...
string IniFile::Content(string const& FileName)
{
...
bool IniFile::SectionExists(string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::RecordExists(string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::AddSection(string const& SectionName, string const& FileName)
{
    if (!Create(FileName))
    {
        return false;
...
bool IniFile::SetValue(string const& KeyName, string const& Value, string const& SectionName, string const& FileName)
{
    if (!Create(FileName))
    {
        return false;
...
bool IniFile::DeleteSection(string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::DeleteRecord(string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::RenameSection(string const& OldSectionName, string const& NewSectionName, string const& FileName)
{
    if (SectionExists(NewSectionName, FileName))                            // If the Section exist
    {
        return false;
    }
...
bool IniFile::Sort(string const& FileName, bool Descending)
{
    vector<IniFile::Record> sections = GetSections(FileName);               // Get a vector of Sections
        ...
        iter != sections.end(); ++iter)                                     // For each Section
    {
        ...
        vector<IniFile::Record> records = GetSection(iter->Section, FileName); // Get a vector of Records for this section
...
bool IniFile::SetSectionComments(string const& Comments, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::SetRecordComments(string const& Comments, string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::CommentSection(char CommentChar, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::CommentRecord(CommentChar cc, string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::UnCommentSection(string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
...
bool IniFile::UnCommentRecord(string const& KeyName, string const& SectionName, string const& FileName)
{
    vector<Record> content;                                                 // Holds the current record
