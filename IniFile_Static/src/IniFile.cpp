...
bool CIniFile::Load(const string& FileName, vector<Record>& content)
{
...
bool CIniFile::Save(const string& FileName, vector<Record>& content)
{
...
std::vector<std::string> CIniFile::GetSectionNames(const string& FileName)
{
...
std::vector<CIniFile::Record> CIniFile::GetSections(const string& FileName)
{
...
std::vector<CIniFile::Record> CIniFile::GetSection(const string& SectionName, const string& FileName)
{
    vector<Record> data;													// Holds the return data
    vector<Record> content;												    // Holds the current record
...
std::vector<CIniFile::Record> CIniFile::GetRecord(const string& KeyName, const string& SectionName, const string& FileName)
{
    vector<Record> data;													// Holds the return data
    vector<Record> content;												    // Holds the current record
...
std::string CIniFile::GetValue(const string& KeyName, const string& SectionName, const string& FileName)
{
...
std::string CIniFile::Content(const string& FileName)
{
